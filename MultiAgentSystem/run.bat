...
SET CP=%CP%;bin\;
java -cp %CP% -gui jade.Boot session:com.u1s1f1.collabsys.session.SessionAgent floor:com.u1s1f1.collabsys.floor.FloorAgent user:com.u1s1f1.collabsys.user.UserAgent